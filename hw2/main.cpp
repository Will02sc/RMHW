...
int main()
{
    ...
    */
    ...
    int found, successes=0 ,cnt= 0;
    Size img_size;
    //循环显示1000帧图像

    while(true)
    {
        if(/*waitKey(1)=='a'&&*/CameraGetImageBuffer(hCamera,&sFrameInfo,&pbyBuffer,1000) == CAMERA_STATUS_SUCCESS)
		{
    ...
    std::vector< int > point_count;Mat camera_matrix( 3, 3, CV_32FC1, Scalar::all( 0 ) );
